...
private static final String TAG="MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this, "You can register now", Toast.LENGTH_LONG).show();
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MainActivity.this,"please re-enter your number",Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError(" Valid  number is required");
                    editTextRegisterMobile.requestFocus();

                }else if(!mobileMatcher.find())
                {
                    Toast.makeText(MainActivity.this,"Mobile Number is not valid.",Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.requestFocus();
                }
                ...
                {
                    Toast.makeText(MainActivity.this," password should not be less then 6 digits",Toast.LENGTH_LONG).show();
    ...
    private void registerUser(String textFullName, String textEmail, String textDoB, String textGender, String textMobile, String textPwd) {
        ...
        auth.createUserWithEmailAndPassword(textEmail,textPwd).addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
